import pygame, random, animation
...
class Ennemy_soldier(animation.AnimationSprite):
    ...
    def damage(self, amount):
        self.health -= amount
        if self.health <= 0:
            self.image = pygame.image.load('P:/Documents/SIO_Cours_INFORMATIQUE/Developpement/Jeu_Python/RoyalTankDestructor/assets/images/terrorists_hurt_1_/terrorists_hurt_1_.png')
    ...
    def update_health_bar(self, surface):
        pygame.draw.rect(surface, (60, 60, 60), [self.rect.x + 15, self.rect.y - 20, self.max_health, 5])  # [X, Y, Largeur, Hauteur(Epaisseur)]
    ...
    def forward(self):
        ...
        if self.rect.x <= 700:
            ...
            self.image = pygame.image.load('P:/Documents/SIO_Cours_INFORMATIQUE/Developpement/Jeu_Python/RoyalTankDestructor/assets/images/terrorists_att_1_/terrorists_att_1_.png')
