...
class AnimationSprite(pygame.sprite.Sprite):
    ...
    def __init__(self, sprite_name, size=(100, 144)): #Sprite_name pour le nom de l'entité à animé
        super().__init__()
        self.size = size
        self.image = pygame.image.load('P:/Documents/SIO_Cours_INFORMATIQUE/Developpement/Jeu_Python/RoyalTankDestructor/assets/images/' + sprite_name + '/' + sprite_name + '.png') #Ou (f'assets/{sprite_name}.png')
...
def load_animation_images(sprite_name):
    ...
    path = f"P:\Documents\SIO_Cours_INFORMATIQUE\Developpement\Jeu_Python\RoyalTankDestructor/assets/images/{sprite_name}/{sprite_name}"
