...
class Tank_signature(pygame.sprite.Sprite): #Un élément sprite est un élément graphique du jeu pouvant se déplacer (SUPER CLASSE)
    ...
    def __init__(self, game):
        ...
        self.game = game
        self.image = pygame.image.load("P:/Documents/SIO_Cours_INFORMATIQUE/Developpement/Jeu_Python/RoyalTankDestructor/assets/images/tank_signature.png") #Lycée
